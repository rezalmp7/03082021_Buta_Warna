                    ...
                    <div class="uk-padding-remove uk-margin-large-top uk-width-1-1" id="body">
                        ...
                        <div class="uk-padding-small uk-margin-medium-top uk-width-1-1 uk-border-rounded bg-color-white">
                            <h3>Tambah Pasien</h3>
                            <form class="uk-form-stacked uk-margin-medium-top" method="post" action="<?php echo base_url(); ?>pasien/aksi_tambah">
                                <div class="uk-margin">
                                    <label class="uk-form-label" for="form-stacked-text">ID Pasien</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input" value="<?php echo sprintf("%04d", $id); ?>" id="form-stacked-text" type="text" placeholder="Nama Pasien..." disabled>
                                        <input class="uk-input" name="id" value="<?php echo $id; ?>" type="hidden">
                                    </div>
                                </div>
                                <div class="uk-margin">
                                    <label class="uk-form-label" for="form-stacked-text">Nama Pasien</label>
                                    <div class="uk-form-controls">
                                        <input class="uk-input" name="nama" id="form-stacked-text" type="text" placeholder="Nama Pasien...">
                                    </div>
                                </div>
                                <div class="uk-margin">
